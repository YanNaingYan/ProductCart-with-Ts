...
const {handleDrawer}=context
  ...
  <div className="flex justify-between items-center py-3">
        ...
        <div className="control-btn flex gap-2">
          <div
            id="searchBar"
            className={`border border-neutral-600 h-12 w-60 flex gap-3 px-2 items-center ${isSearch && 'opacity-0 -translate-y-full'} `}
          ...
          >
            ...
            />
            <button id="clearSearchBarInput" onClick={handleClear}>
              <svg
          ...
          <button
            ...
            id="searchBtn" onClick={handleSearch}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
